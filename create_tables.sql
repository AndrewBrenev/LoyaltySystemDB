...
insert into clients values (1,'Petor','Baranov','Ilich','+79137612974','baranov_ptr@gmail.com');
insert into clients values (2,'Oksana','Samvilova','Alexeevna','+79523490045','oksi@gmail.com');
insert into clients values (3,'Samvel','Sarkisov','Ahmatovich','+79828765109','smvl3Sark@gmail.com');
insert into clients values (4,'Alexs','Lumpkin','Vladimirovich','+79533491150','aLumpkin@gmail.com');
insert into clients values (5,'Katherine','Petrova','Olegovna','+79135679318','kp@mail.ru');
...
insert into cards values (3,'c713ef2a39ca986ebaf7a29f1a8eab27669c5586',TO_DATE('2017/08/12', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),3,2);
insert into cards values (4,'1eeb45e376f054ef998768974f35997209393660',TO_DATE('2019/09/02', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),4,3);
insert into cards values (5,'c0a6bf8c168c88c2c83409a337bce422890d6bb2',TO_DATE('2018/10/01', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),4,4);
insert into cards values (6,'1583df6e775b211a58bad5b5205dac59674f442a',TO_DATE('2020/01/30', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),1,5);
insert into cards values (7,'f58b1b630450308dc68f6a9dc6e1a6f1915825cc',TO_DATE('2019/12/29', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),1,1);
insert into cards values (8,'c4940c0f5162b254a0cd635109f434929c537977',TO_DATE('2018/05/01', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),6,5);
insert into cards values (9,'d554126d7ce6f3cfa9d1d371efa10837861a6913',TO_DATE('2020/04/29', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),6,5);
insert into cards values (10,'606e0cf47ad6fe91461732139ecbeb014c8e2bad',TO_DATE('2019/03/17', 'yyyy/mm/dd'),TO_DATE('2020/11/29', 'yyyy/mm/dd'),6,5);
...
insert into merchants values (1,'LENTA 234','Bolshay 2');
insert into merchants values (2,'Gigant 12','Vibornaya 122');
insert into merchants values (3,'LENTA 653','Gogolya 24');
...
CREATE TABLE MERCHANTS_PROGRAMS  (
   ...
   constraint mrch_programs_proc_check CHECK ( cashback_proc >= 0)
);
...
CREATE TABLE MCC_PROGRAMS  (
   ...
   constraint mcc_programs_proc_check CHECK ( cashback_proc >= 0)
);
...
(2342,'input.csv','input',TO_DATE(sysdate,'YYYY-MM-DD HH24:MI:SS'),TO_DATE('2020-04-10 19:34:34','YYYY-MM-DD HH24:MI:SS'),'new');
...
CREATE TABLE TRANSACTIONS  (
    ...
    card_id number not null,
    mrch_prog_id number not null,
    mcc_prog_id number not null,
